...
offs_t hd61700_cpu_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( hd61700 );
	return CPU_DISASSEMBLE_NAME(hd61700)(this, stream, pc, opcodes, params, options);
}
