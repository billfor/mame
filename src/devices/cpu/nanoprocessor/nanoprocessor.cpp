...
offs_t hp_nanoprocessor_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE(hp_nanoprocessor);
	return CPU_DISASSEMBLE_NAME(hp_nanoprocessor)(this, stream, pc, opcodes, params, options);
}
