...
offs_t v25_common_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	return necv_dasm_one(stream, pc, opcodes, params, m_v25v35_decryptiontable);
}
