...
offs_t tms34010_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( tms34010 );

	return CPU_DISASSEMBLE_NAME(tms34010)(this, stream, pc, opcodes, params, options);
}


offs_t tms34020_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( tms34020 );

	return CPU_DISASSEMBLE_NAME(tms34020)(this, stream, pc, opcodes, params, options);
}
