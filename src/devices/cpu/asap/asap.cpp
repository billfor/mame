...
uint32_t asap_device::opcode_alignment() const
{
	return 4;
}
...
offs_t asap_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( asap );
	return CPU_DISASSEMBLE_NAME(asap)(this, stream, pc, opcodes, params, options);
}
