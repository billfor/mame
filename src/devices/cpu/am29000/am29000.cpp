...
offs_t am29000_cpu_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( am29000 );
	return CPU_DISASSEMBLE_NAME(am29000)(this, stream, pc, opcodes, params, options);
}
