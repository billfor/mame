...
uint32_t parodius_state::screen_update_parodius(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect)
{
	...
	bg_colorbase = 0;//m_k053251->get_palette_index(k053251_device::CI0);
	m_sprite_colorbase   = 0;//m_k053251->get_palette_index(k053251_device::CI1);
	m_layer_colorbase[0] = 0;//m_k053251->get_palette_index(k053251_device::CI2);
	m_layer_colorbase[1] = 0;//m_k053251->get_palette_index(k053251_device::CI4);
	m_layer_colorbase[2] = 0;//m_k053251->get_palette_index(k053251_device::CI3);

	m_k052109->tilemap_update();

	layer[0] = 0;
	m_layerpri[0] = 0;//m_k053251->get_priority(k053251_device::CI2);
	layer[1] = 1;
	m_layerpri[1] = 0;//m_k053251->get_priority(k053251_device::CI4);
	layer[2] = 2;
	m_layerpri[2] = 0;//m_k053251->get_priority(k053251_device::CI3);
