...
class konamigx_state : public driver_device, public flow_render::interface
{
public:
	...
	flow_render::renderer *m_renderer_force_bgcolor;
	std::array<flow_render::input_sb_u16 *, 2> m_renderer_force_bgcolor_input;
	std::array<flow_render::output_sb_u16 *, 2> m_renderer_force_bgcolor_output;
	...
	void fr_setup_single_screen_no_sub(flow_render::manager *manager);
	void fr_setup_single_screen_voxels(flow_render::manager *manager);
